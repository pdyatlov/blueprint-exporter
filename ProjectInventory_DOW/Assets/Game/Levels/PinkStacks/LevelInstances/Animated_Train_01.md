...
| Field | Value |
|---|---|
| Asset path | `/Game/Levels/PinkStacks/LevelInstances/Animated_Train_01.Animated_Train_01` |
| Asset name | `Animated_Train_01` |
| Subclass | `Blueprint` |
...
- `DefaultSceneRoot` — `SceneComponent` [root] @ socket `None`
  - `Audio` — `AudioComponent` @ socket `None`
  - `ChildActor` — `ChildActorComponent` @ socket `None`
- `InterpToMovement` — `InterpToMovementComponent` @ socket `None`
...
- `/Game/Levels/PinkStacks/LevelInstances/BP_Train_Components` [asset]
