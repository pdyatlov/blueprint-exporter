# BP_CrowdMassAI_Merge

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.BP_CrowdMassAI_Merge` |
| Asset name | `BP_CrowdMassAI_Merge` |
| Subclass | `Blueprint` |
...
| `Skeletal Mesh Array` | `TArray<object<SkeletalMesh>>` | — | `Default` | — | — | InstanceEditable, Private |
| `NPCManager` | `object<BP_NPCGenManager_C>` | `None` | `Default` | — | — | InstanceEditable, Private |
...
- `ArrowComponent` (`TObjectPtr<UArrowComponent>`) [instanced] = `/Script/Engine.ArrowComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.Default__BP_CrowdMassAI_Merge_...`
- `CapsuleComponent` (`TObjectPtr<UCapsuleComponent>`) [instanced] = `/Script/Engine.CapsuleComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.Default__BP_CrowdMassAI_Merg...`
- `CharacterMovement` (`TObjectPtr<UCharacterMovementComponent>`) [instanced] = `/Script/Engine.CharacterMovementComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.Default__BP_CrowdM...`
- `Mesh` (`TObjectPtr<USkeletalMeshComponent>`) [instanced] = `/Script/Engine.SkeletalMeshComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.Default__BP_CrowdMassAI...`
- `PrimaryActorTick` (`FActorTickFunction`) = `(bStartWithTickEnabled=False)`
- `RootComponent` (`TObjectPtr<USceneComponent>`) [instanced] = `/Script/Engine.CapsuleComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Merge.Default__BP_CrowdMassAI_Merg...`
...
- `/Game/Blueprints/AI/MassAI/CrowdGen/BP_NPCGenManager` [asset]
