...
- `ArrowComponent` (`TObjectPtr<UArrowComponent>`) [instanced] = `/Script/Engine.ArrowComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Headless.Default__BP_CrowdMassAI_Hea...`
- `CapsuleComponent` (`TObjectPtr<UCapsuleComponent>`) [instanced] = `/Script/Engine.CapsuleComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Headless.Default__BP_CrowdMassAI_H...`
- `CharacterMovement` (`TObjectPtr<UCharacterMovementComponent>`) [instanced] = `/Script/Engine.CharacterMovementComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Headless.Default__BP_Cro...`
- `Mesh` (`TObjectPtr<USkeletalMeshComponent>`) [instanced] = `/Script/Engine.SkeletalMeshComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Headless.Default__BP_CrowdMas...`
- `RootComponent` (`TObjectPtr<USceneComponent>`) [instanced] = `/Script/Engine.CapsuleComponent'/Game/Blueprints/AI/MassAI/CrowdGen/BP_CrowdMassAI_Headless.Default__BP_CrowdMassAI_H...`
