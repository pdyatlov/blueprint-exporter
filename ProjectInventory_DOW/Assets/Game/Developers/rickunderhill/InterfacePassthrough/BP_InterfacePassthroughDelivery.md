# BP_InterfacePassthroughDelivery

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/Developers/rickunderhill/InterfacePassthrough/BP_InterfacePassthroughDelivery.BP_InterfacePassthroughDelivery` |
| Asset name | `BP_InterfacePassthroughDelivery` |
| Subclass | `Blueprint` |
