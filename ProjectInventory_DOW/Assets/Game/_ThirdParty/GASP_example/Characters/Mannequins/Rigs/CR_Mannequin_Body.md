...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/Mannequins/Rigs/CR_Mannequin_Body.CR_Mannequin_Body` |
...
- `DynamicHierarchy` (`TObjectPtr<URigHierarchy>`) = `/Script/ControlRig.RigHierarchy'/Game/_ThirdParty/GASP_example/Characters/Mannequins/Rigs/CR_Mannequin_Body.Default__...`
...
- Event graph: `EventGraph` (237 nodes)
...
- `/Game/_ThirdParty/GASP_example/Characters/Mannequins/Meshes/SKM_Manny_Simple` [asset]
