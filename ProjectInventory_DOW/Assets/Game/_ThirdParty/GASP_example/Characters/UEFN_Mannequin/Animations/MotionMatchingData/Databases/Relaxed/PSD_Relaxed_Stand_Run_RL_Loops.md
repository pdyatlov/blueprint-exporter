# PSD_Relaxed_Stand_Run_RL_Loops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Run_RL_Loops.PSD_Relaxed_Stand_Run_RL_Loops` |
| Asset name | `PSD_Relaxed_Stand_Run_RL_Loops` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Run_Loop_RL.M_Relaxed_Run_Loop_RL` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Run_Switch_RR_RL_Lfoot.M_Relaxed_Run_Switch_RR_RL_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 2 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Run_Switch_RR_RL_Rfoot.M_Relaxed_Run_Switch_RR_RL_Rfoot` | _full_ | `UnmirroredOnly` | yes |
