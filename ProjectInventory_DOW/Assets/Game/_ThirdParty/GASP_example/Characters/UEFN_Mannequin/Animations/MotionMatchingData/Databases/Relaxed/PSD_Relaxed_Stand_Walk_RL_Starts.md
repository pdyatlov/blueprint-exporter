# PSD_Relaxed_Stand_Walk_RL_Starts

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Walk_RL_Starts.PSD_Relaxed_Stand_Walk_RL_Starts` |
| Asset name | `PSD_Relaxed_Stand_Walk_RL_Starts` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Relaxed_Walk_Start_RL_Lfoot.M_Relaxed_Walk_Start_RL_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Relaxed_Walk_Start_RL_Rfoot.M_Relaxed_Walk_Start_RL_Rfoot` | _full_ | `UnmirroredOnly` | yes |
