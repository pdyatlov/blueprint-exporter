# PSD_Relaxed_Stand_Run_LR_Loops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Run_LR_Loops.PSD_Relaxed_Stand_Run_LR_Loops` |
| Asset name | `PSD_Relaxed_Stand_Run_LR_Loops` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Run_Loop_LR_offset.M_Relaxed_Run_Loop_LR_offset` | _full_ | `UnmirroredOnly` | yes |
