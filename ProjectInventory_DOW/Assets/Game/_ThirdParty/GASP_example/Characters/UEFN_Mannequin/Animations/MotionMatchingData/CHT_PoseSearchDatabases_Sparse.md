...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/CHT_PoseSearchDatabases_Sparse.CHT_PoseSearchDatabases_Sparse` |
| Asset name | `CHT_PoseSearchDatabases_Sparse` |
...
| 3 | `/Script/Chooser.EnumColumn` | yes | — | — | `/Script/Chooser.EnumContextProperty` | — |
