...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Extreme_Sparse/PSD_Extreme_Sparse_Stand_Walk_Starts.PSD_Extreme_Sparse_Stand_Walk_Starts` |
| Asset name | `PSD_Extreme_Sparse_Stand_Walk_Starts` |
...
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Neutral_Walk_Start_F_Rfoot.M_Neutral_Walk_Start_F_Rfoot` | _full_ | `UnmirroredOnly` | yes |
| 2 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Neutral_Walk_Start_B_Rfoot.M_Neutral_Walk_Start_B_Rfoot` | _full_ | `UnmirroredOnly` | yes |
