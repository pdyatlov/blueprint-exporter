# PSD_Relaxed_Stand_Run_F_GaitTransitions

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Run_F_GaitTransitions.PSD_Relaxed_Stand_Run_F_GaitTransitions` |
| Asset name | `PSD_Relaxed_Stand_Run_F_GaitTransitions` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Transition_Walk_to_Run_Lfoot.M_Relaxed_Transition_Walk_to_Run_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Transition_Walk_to_Run_Rfoot.M_Relaxed_Transition_Walk_to_Run_Rfoot` | _full_ | `UnmirroredOnly` | yes |
| 2 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Transition_Sprint_to_Run_Lfoot.M_Relaxed_Transition_Sprint_to_Run_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 3 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Transition_Sprint_to_Run_Rfoot.M_Relaxed_Transition_Sprint_to_Run_Rfoot` | _full_ | `UnmirroredOnly` | yes |
