...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Traversal/CHT_TraversalMontages_Mover.CHT_TraversalMontages_Mover` |
| Asset name | `CHT_TraversalMontages_Mover` |
