# PSD_Relaxed_Stand_Sprint_Lands_Heavy

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Sprint_Lands_Heavy.PSD_Relaxed_Stand_Sprint_Lands_Heavy` |
| Asset name | `PSD_Relaxed_Stand_Sprint_Lands_Heavy` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Relaxed_Jump_F_Land_Sprint_Heavy_Lfoot.M_Relaxed_Jump_F_Land_Sprint_Heavy_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Relaxed_Jump_F_Land_Sprint_Heavy_Rfoot.M_Relaxed_Jump_F_Land_Sprint_Heavy_Rfoot` | _full_ | `UnmirroredOnly` | yes |
