# PSD_Relaxed_Stand_Run_F_Loops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Run_F_Loops.PSD_Relaxed_Stand_Run_F_Loops` |
| Asset name | `PSD_Relaxed_Stand_Run_F_Loops` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Run/M_Relaxed_Run_Loop_F.M_Relaxed_Run_Loop_F` | _full_ | `UnmirroredOnly` | yes |
