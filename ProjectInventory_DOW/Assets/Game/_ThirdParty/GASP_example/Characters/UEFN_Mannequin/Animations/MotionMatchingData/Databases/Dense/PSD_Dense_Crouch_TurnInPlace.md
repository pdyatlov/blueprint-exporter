...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Dense/PSD_Dense_Crouch_TurnInPlace.PSD_Dense_Crouch_TurnInPlace` |
| Asset name | `PSD_Dense_Crouch_TurnInPlace` |
