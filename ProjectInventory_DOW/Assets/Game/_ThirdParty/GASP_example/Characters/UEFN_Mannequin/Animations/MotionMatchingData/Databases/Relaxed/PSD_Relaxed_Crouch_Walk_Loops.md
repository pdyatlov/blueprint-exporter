# PSD_Relaxed_Crouch_Walk_Loops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Crouch_Walk_Loops.PSD_Relaxed_Crouch_Walk_Loops` |
| Asset name | `PSD_Relaxed_Crouch_Walk_Loops` |
...
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Crouch/M_Neutral_Crouch_Loop_F.M_Neutral_Crouch_Loop_F` | _full_ | `UnmirroredOnly` | yes |
| 2 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Crouch/M_Neutral_Crouch_Loop_LL.M_Neutral_Crouch_Loop_LL` | _full_ | `UnmirroredOnly` | yes |
| 3 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Crouch/M_Neutral_Crouch_Loop_LR.M_Neutral_Crouch_Loop_LR` | _full_ | `UnmirroredOnly` | yes |
| 4 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Crouch/M_Neutral_Crouch_Loop_RL.M_Neutral_Crouch_Loop_RL` | _full_ | `UnmirroredOnly` | yes |
| 5 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Crouch/M_Neutral_Crouch_Loop_RR.M_Neutral_Crouch_Loop_RR` | _full_ | `UnmirroredOnly` | yes |
