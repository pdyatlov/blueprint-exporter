# PSD_Relaxed_Stand_Walk_LL_Loops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Walk_LL_Loops.PSD_Relaxed_Stand_Walk_LL_Loops` |
| Asset name | `PSD_Relaxed_Stand_Walk_LL_Loops` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Relaxed_Walk_Loop_LL.M_Relaxed_Walk_Loop_LL` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Relaxed_Walk_Switch_LR_LL_Lfoot.M_Relaxed_Walk_Switch_LR_LL_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 2 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Walk/M_Relaxed_Walk_Switch_LR_LL_Rfoot.M_Relaxed_Walk_Switch_LR_LL_Rfoot` | _full_ | `UnmirroredOnly` | yes |
