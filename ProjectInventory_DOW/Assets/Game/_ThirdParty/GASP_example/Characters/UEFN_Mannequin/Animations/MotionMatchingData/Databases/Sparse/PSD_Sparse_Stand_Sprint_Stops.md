# PSD_Sparse_Stand_Sprint_Stops

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Sparse/PSD_Sparse_Stand_Sprint_Stops.PSD_Sparse_Stand_Sprint_Stops` |
| Asset name | `PSD_Sparse_Stand_Sprint_Stops` |
