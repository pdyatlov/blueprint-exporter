# PSD_Relaxed_Stand_Sprint_Jump

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Relaxed/PSD_Relaxed_Stand_Sprint_Jump.PSD_Relaxed_Stand_Sprint_Jump` |
| Asset name | `PSD_Relaxed_Stand_Sprint_Jump` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Relaxed_Jump_F_Start_Sprint_Lfoot.M_Relaxed_Jump_F_Start_Sprint_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Relaxed_Jump_F_Start_Sprint_Rfoot.M_Relaxed_Jump_F_Start_Sprint_Rfoot` | _full_ | `UnmirroredOnly` | yes |
