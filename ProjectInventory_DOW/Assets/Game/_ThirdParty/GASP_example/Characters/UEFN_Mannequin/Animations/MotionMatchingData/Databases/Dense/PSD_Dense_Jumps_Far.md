...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/MotionMatchingData/Databases/Dense/PSD_Dense_Jumps_Far.PSD_Dense_Jumps_Far` |
| Asset name | `PSD_Dense_Jumps_Far` |
...
|---:|---|---|---|---|:---:|
| 0 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Neutral_Jump_F_Start_Sprint_Lfoot.M_Neutral_Jump_F_Start_Sprint_Lfoot` | _full_ | `UnmirroredOnly` | yes |
| 1 | `AnimSequence` | `/Game/_ThirdParty/GASP_example/Characters/UEFN_Mannequin/Animations/Jump/M_Neutral_Jump_F_Start_Sprint_Rfoot.M_Neutral_Jump_F_Start_Sprint_Rfoot` | _full_ | `UnmirroredOnly` | yes |
