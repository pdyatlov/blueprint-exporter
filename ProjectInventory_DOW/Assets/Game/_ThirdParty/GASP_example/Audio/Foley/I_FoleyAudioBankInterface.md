# I_FoleyAudioBankInterface

## Identity

| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Audio/Foley/I_FoleyAudioBankInterface.I_FoleyAudioBankInterface` |
| Asset name | `I_FoleyAudioBankInterface` |
| Subclass | `Blueprint` |
