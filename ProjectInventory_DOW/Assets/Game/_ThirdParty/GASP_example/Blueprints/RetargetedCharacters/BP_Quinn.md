...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Blueprints/RetargetedCharacters/BP_Quinn.BP_Quinn` |
| Asset name | `BP_Quinn` |
| Subclass | `Blueprint` |
...
- `/Game/_ThirdParty/GASP_example/Characters/UE5_Mannequins/Meshes/SKM_Quinn_Simple` [asset]
