...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Blueprints/RetargetedCharacters/BP_Twinblast.BP_Twinblast` |
| Asset name | `BP_Twinblast` |
| Subclass | `Blueprint` |
...
- `DefaultSceneRoot` — `SceneComponent` [root] @ socket `None`
  - `TwinBlast` — `SkeletalMeshComponent` @ socket `None`
