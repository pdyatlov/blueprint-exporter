...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/GASP_example/Blueprints/AnimModifiers/AM_OrientationWarpingAlpha.AM_OrientationWarpingAlpha` |
| Asset name | `AM_OrientationWarpingAlpha` |
| Subclass | `Blueprint` |
...
| `CurveName` | `name` | `Enable_OrientationWarping` | `Default` | — | — | InstanceEditable |
...
| `BlendOutTime` | `real<double>` | `0.250000` | `Default` | — | — | InstanceEditable, Private |
...
- Event graph: `EventGraph` (133 nodes)
