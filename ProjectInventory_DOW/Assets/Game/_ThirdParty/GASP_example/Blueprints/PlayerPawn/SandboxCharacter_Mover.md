...
- Interface override of `/Game/_ThirdParty/GASP_example/Standards/GameActor/iGameActor.iGameActor_C`
- Access: `Public`
- Flags: —
- Inputs: `()`
...
- Interface override of `/Game/_ThirdParty/GASP_example/Standards/iWeaponOwner.iWeaponOwner_C`
- Access: `Public`
- Flags: —
- Inputs: `()`
...
- `Capsule` — `CapsuleComponent` @ socket `None`
  - `SkeletalMesh` — `SkeletalMeshComponent` @ socket `None`
    ...
    - `SkeletalMesh3` — `SkeletalMeshComponent` @ socket `None`
    - `Torso` — `SkeletalMeshComponent` @ socket `None`
    - `SkeletalMesh2` — `SkeletalMeshComponent` @ socket `None`
    - `Gloves` — `SkeletalMeshComponent` @ socket `None`
...
- `AC_WeaponController` — `AC_WeaponController_C` @ socket `None`
...
- Event graph: `EventGraph` (239 nodes)
