...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/UltraDynamicSky/Blueprints/System/Editor_UI/UDS_VersionInfo.UDS_VersionInfo` |
| Asset name | `UDS_VersionInfo` |
| Subclass | `Blueprint` |
...
|---|---|---|---|---|---|---|
| `Version Label` | `string` | — | `Default` | — | — | InstanceEditable, Private |
