...
| Field | Value |
|---|---|
| Asset path | `/Game/_ThirdParty/UltraDynamicSky/Blueprints/System/UDS_Environment_Sound.UDS_Environment_Sound` |
| Asset name | `UDS_Environment_Sound` |
| Subclass | `Blueprint` |
...
|---|---|---|---|---|---|---|
| `Metasound Source` | `softobject<MetaSoundSource>` | `None` | `Default` | — | — | InstanceEditable |
| `Volume` | `real<double>` | `1.000000` | `Default` | — | — | InstanceEditable |
| `Parameter Overrides` | `TArray<struct<AudioParameter>>` | — | `Default` | — | — | InstanceEditable |
